...
struct CSCTMBHeader2020 : public CSCVTMBHeaderFormat {
  ...
  virtual uint16_t HMT_nhits() const { return ((bits.hmt_nhits_bit0&0x1) + ((bits.hmt_nhits_bit1&0x1)<<1) + ((bits.hmt_nhits_bits_high&0x1F) << 2)); }
  ...
  virtual uint16_t GEM_sync_dataword() const { return ((bits.copad_match&0xFF) + (bits.gemA_vpf<<8) + (bits.gemB_vpf<<9) + (bits.gemA_over_flow<<10) + (bits.gemB_over_flow<<11) + (bits.gemA_sync<<12) + (bits.gemB_sync<<13) + (bits.gems_sync<<14)); }
  virtual uint16_t GEM_timing_dataword() const { return ((bits.gem_delay&0xFF) + ((bits.gem_clct_win&0xF)<<8) + ((bits.alct_gem_win&0x7)<<12)); }

  virtual uint16_t Run3_CLCT_patternID() const { return (bits.MPC_Muon_clct_pattern_low | (bits.MPC_Muon_clct_pattern_bit5<<4)); }
  // == 
  ...
  unsigned hmt_nhits_bits_high:5, alct_ecc_err:2, cfeb_badbits_found:5, cfeb_badbits_blocked:1, alctCfg:1, bx0_match:1, flag30:1;
  unsigned MPC_Muon0_alct_key_wire:7, MPC_Muon_clct_pattern_low:4, MPC_Muon0_lct_quality:3, MPC_Muon0_clct_QuarterStrip:1, flag31:1;
  // 32
  unsigned MPC_Muon0_clct_key_halfstrip:8, MPC_Muon0_clct_LR:1, MPC_Muon0_clct_EighthStrip:1, MPC_Muon_alct_bxn:1, MPC_Muon0_clct_bx0:1, MPC_Muon0_clct_bend_low:3, flag32:1;
  unsigned MPC_Muon1_alct_key_wire:7, MPC_Muon_clct_pattern_bit5:1, MPC_Muon_HMT_high:3, MPC_Muon1_lct_quality:3, MPC_Muon1_clct_QuarterStrip:1, flag33:1;
  unsigned MPC_Muon1_clct_key_halfstrip:8, MPC_Muon1_clct_LR:1, MPC_Muon1_clct_EighthStrip:1, MPC_Muon_HMT_bit0:1, MPC_Muon1_clct_bx0:1, MPC_Muon1_clct_bend_low:3, flag34:1;
  unsigned MPC_Muon0_lct_vpf:1, MPC_Muon0_clct_bend_bit4:1, MPC_Muon1_lct_vpf:1, MPC_Muon1_clct_bend_bit4:1, MPCDelay:4, MPCAccept:2, CFEBsEnabled:5, flag35:1;
  // 36
