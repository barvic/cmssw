...
std::vector<CSCCorrelatedLCTDigi> CSCTMBHeader2020_GEM_Run3b::CorrelatedLCTDigis(uint32_t idlayer) const {
  ...
  CSCCorrelatedLCTDigi digi(1,
                            ...
                            0,
                            0,
                            CSCCorrelatedLCTDigi::Version::Run3b,
...
void CSCTMBHeader2020_GEM_Run3b::addCorrelatedLCT0(const CSCCorrelatedLCTDigi& digi) {
  ...
  bits.MPC_Muon0_clct_bend_low = (digi.getSlopeRun3b() >> 2 ) & 0x7;
  bits.MPC_Muon0_clct_bend_high = (digi.getSlopeRun3b() >> 5) & 0x1;
  bits.MPC_Muon0_clct_bend_run3b_extra = digi.getSlopeRun3b() & 0x3;
...
void CSCTMBHeader2020_GEM_Run3b::addCorrelatedLCT1(const CSCCorrelatedLCTDigi& digi) {
  ...
  // Run3-b 6-bits slope/bend
  bits.MPC_Muon1_clct_bend_low = (digi.getSlopeRun3b() >>2) & 0x7;
  bits.MPC_Muon1_clct_bend_high = (digi.getSlopeRun3b() >> 5) & 0x1;
  bits.MPC_Muon1_clct_bend_run3b_extra = digi.getSlopeRun3b() & 0x3;
